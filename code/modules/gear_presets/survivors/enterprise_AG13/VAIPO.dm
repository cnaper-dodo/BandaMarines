// /obj/effect/landmark/survivor_spawner/AG13
// AG13.dmm
...
/datum/equipment_preset/survivor/contractor/New()
	. = ..()
	access = get_access(ACCESS_LIST_EMERGENCY_RESPONSE)


/datum/equipment_preset/survivor/contractor/load_name(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/survivor/contractor/load_id(mob/living/carbon/human/new_human, client/mob_client)
...
/datum/equipment_preset/survivor/contractor/duty/standard
...
/datum/equipment_preset/survivor/contractor/duty/standard/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/survivor/contractor/duty/heavy
...
/datum/equipment_preset/survivor/contractor/duty/heavy/load_gear(mob/living/carbon/human/new_human)
...
//*****************************************************************************************************/
/datum/equipment_preset/survivor/contractor/duty/engi
...
/datum/equipment_preset/survivor/contractor/duty/engi/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/survivor/contractor/duty/medic
...
/datum/equipment_preset/survivor/contractor/duty/medic/load_gear(mob/living/carbon/human/new_human)
	//clothing
	new_human.equip_to_slot_or_del(new /obj/item/clothing/under/tshirt/w_br, WEAR_BODY)
	new_human.equip_to_slot_or_del(new headset_type, WEAR_L_EAR)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/suit/storage/marine/light/vest, WEAR_JACKET)
...
/datum/equipment_preset/survivor/contractor/duty/leader
...
/datum/equipment_preset/survivor/contractor/duty/leader/load_gear(mob/living/carbon/human/new_human)
	//clothes
	new_human.equip_to_slot_or_del(new headset_type, WEAR_L_EAR)
...
//*****************************************************************************************************/
/datum/equipment_preset/survivor/synth/contractor/duty
...
/datum/equipment_preset/survivor/synth/contractor/New()
	. = ..()
	access = get_access(ACCESS_LIST_EMERGENCY_RESPONSE)

/datum/equipment_preset/survivor/synth/contractor/duty/load_name(mob/living/carbon/human/new_human, randomise)
	new_human.gender = pick(MALE, FEMALE)
...
/datum/equipment_preset/survivor/synth/contractor/duty/load_gear(mob/living/carbon/human/new_human)
	//back
